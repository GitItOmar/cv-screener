export class DataValidator {
  ...
  async validateResumeData(data) {
    console.info('[DataValidator] Starting resume data validation');
    ...
    try {
      ...
      console.info('[DataValidator] Validation completed:', {
  ...
  validateStructure(data, result) {
    console.debug('[DataValidator] Validating data structure');
  ...
  async validatePositionAppliedFor(section, result) {
    console.debug('[DataValidator] Validating position applied for');
  ...
  async validateSelfEvaluation(section, result) {
    console.debug('[DataValidator] Validating self evaluation');
  ...
  async validateSkillsAndSpecialties(section, result) {
    console.debug('[DataValidator] Validating skills and specialties');
  ...
  async validateWorkExperience(section, result) {
    console.debug('[DataValidator] Validating work experience');
  ...
  async validateBasicInformation(section, result) {
    console.debug('[DataValidator] Validating basic information');
  ...
  async validateEducationBackground(section, result) {
    console.debug('[DataValidator] Validating education background');
  ...
  performCrossValidation(data, result) {
    console.debug('[DataValidator] Performing cross-validation');
