    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 mb-16">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900">Screen 100+ CVs in minutes.</h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Bulk upload CVs, let AI apply best-practice screening, then swipe left/right to finalize.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Drag & drop, CSV/PDF/DOCX support for hundreds of CVs at once.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Best-practice scoring, skills matching, and red-flag detection.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">Keyboard shortcuts, undo functionality, shortlist and export.</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="formats">
              ...
              <AccordionContent>
                We support PDF, DOCX, and CSV files. You can upload individual files or bulk upload via CSV with
                candidate information and resume links.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="ai-scoring">
              <AccordionTrigger>How does the AI score work?</AccordionTrigger>
              <AccordionContent>
                Our AI analyzes CVs against your job requirements, scoring candidates on skills match, experience level,
                and identifying potential red flags. All scoring criteria are transparent and customizable.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="undo">
              <AccordionTrigger>Can I undo decisions?</AccordionTrigger>
              <AccordionContent>
                Yes! Every swipe decision can be undone. You can also bulk actions and review your decision history at
                any time.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="security">
              ...
              <AccordionContent>
                Absolutely. We're fully GDPR compliant with end-to-end encryption, automatic data deletion policies, and
                comprehensive audit trails. Your candidate data is never shared or used for training.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <footer className="border-t border-gray-200 py-8 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-2">
          <p className="text-sm text-gray-600">© {new Date().getFullYear()} Our Company. All rights reserved.</p>
