...
import { Upload, FileText, Brain, Zap, Shield, X, CheckCircle, AlertCircle, Clock } from "lucide-react"
...
export default function UploadPage() {
  ...
  const [uploadStats, setUploadStats] = useState({ succeeded: 0, failed: 0, total: 0, startTime: null })
  ...
  const uploadAll = async () => {
    ...
    setIsUploading(true)
    setUploadStats({ succeeded: 0, failed: 0, total: files.length, startTime: Date.now() })
  ...
  const overallProgress = files.length > 0 ? ((succeededCount + failedCount) / files.length) * 100 : 0
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Drop CVs in PDF, DOC, or ZIP format</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Our AI analyzes skills, experience, and fit</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Quick yes/no decisions on pre-scored candidates</p>
                  </div>
                </div>
                ...
                <Alert>
                  ...
                  <AlertDescription className="text-sm">
                    <strong>GDPR & Security:</strong> Files are processed securely and can be deleted at any time. We
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-3">
                                  <Badge
                                    ...
                                    {fileData.status === "done" && <CheckCircle className="w-3 h-3 mr-1" />}
                                    {fileData.status === "failed" && <AlertCircle className="w-3 h-3 mr-1" />}
                                    {fileData.status === "uploading" && <Clock className="w-3 h-3 mr-1" />}
                  ...
                  <div className="sticky bottom-0 bg-white border-t pt-4 -mx-6 px-6 -mb-6 pb-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-2">
                        <Checkbox id="gdpr-consent" checked={gdprConsent} onCheckedChange={setGdprConsent} />
              ...
              (<Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center text-sm text-gray-600">
                    ...
                    {uploadStats.startTime ? Math.round((Date.now() - uploadStats.startTime) / 1000) : 0} seconds
                  </div>
      ...
      <div aria-live="polite" className="sr-only">
        {isUploading && `Uploading ${uploadingCount} files. ${succeededCount} completed, ${failedCount} failed.`}
