...
export default function ReviewPage() {
  ...
  const filteredCandidates = candidates.filter((candidate) => {
    if (roleFilter !== "all" && !candidate.role.toLowerCase().includes(roleFilter.toLowerCase())) return false
  ...
  const handleReject = () => {
    ...
    setHistory(
      (prev) => [...prev, { action: "reject", candidate: currentCandidate, index: currentIndex }]
    )
  ...
  const handleShortlist = () => {
    ...
    setHistory(
      (prev) => [...prev, { action: "shortlist", candidate: currentCandidate, index: currentIndex }]
    )
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-semibold text-gray-600">No candidates match your filters</h2>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant={getScoreBadge(currentCandidate.score).variant}>{currentCandidate.score}%</Badge>
                      </div>
